                  ...
                  >
                    ...
                    <div className="bg-white p-6 border border-slate-200 rounded-xl shadow-sm">
                      <div className="flex items-center gap-4 border-b-2 border-black pb-4">
                        <div className="h-12 w-12 bg-slate-100 rounded-lg flex items-center justify-center text-[8px] text-slate-400 font-bold text-center">LOGO</div>
                        <div className="flex-1">
                          <h1 className="text-sm font-black uppercase tracking-tight">{brandSettings.schoolName}</h1>
                          <div className="text-[8px] text-slate-400 font-bold uppercase tracking-widest">School Address / Motto</div>
                        </div>
                      </div>
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  <span className="text-[10px] text-slate-400">AI will pick one of the 4 countries randomly for each generation.</span>
                </button>
              </div>
            </div>
          </div>
