...
D. Teacher Mode (Error Correction: 1 paragraph with 5 errors, Students rewrite below) (not topic-based)`,
  ...
  // NEW REQUESTED TYPES
  { id: 'v_box_vocab_1', category: 'VOCABULARY', label: 'Box Vocabulary (Style 1)', professionalLabel: 'Fill in the blanks using the words from the box.', prompt: 'Part: Fill in the blanks using the words from the box. MANDATORY: Use a <div> with class="word-bank-box-alt" for the word bank. Provide 10 sentences.', columnCount: 1 },
  { id: 'v_box_vocab_2', category: 'VOCABULARY', label: 'Box Vocabulary (Style 2)', professionalLabel: 'Complete the paragraph using the words from the box.', prompt: 'Part: Complete the paragraph using the words from the box. MANDATORY: Use a <div> with class="word-bank-box-alt" for the word bank. Generate a coherent paragraph.', columnCount: 1 },
  { id: 'v_box_vocab_3', category: 'VOCABULARY', label: 'Box Vocabulary (Style 3)', professionalLabel: 'Match the words in the box to their definitions.', prompt: 'Part: Match the words in the box to their definitions. MANDATORY: Use a <div> with class="word-bank-box-alt" for the word bank. Provide 10 definitions.', columnCount: 1 },
  { id: 'v_box_vocab_4', category: 'VOCABULARY', label: 'Box Vocabulary (Style 4)', professionalLabel: 'Write the correct word from the box next to its synonym.', prompt: 'Part: Write the correct word from the box next to its synonym. MANDATORY: Use a <div> with class="word-bank-box-alt" for the word bank. Provide 10 synonyms.', columnCount: 1 },
  { id: 'v_box_vocab_5', category: 'VOCABULARY', label: 'Box Vocabulary (Style 5)', professionalLabel: 'Identify the word from the box that fits each description.', prompt: 'Part: Identify the word from the box that fits each description. MANDATORY: Use a <div> with class="word-bank-box-alt" for the word bank. Provide 10 descriptions.', columnCount: 1 },

  { id: 'v_matching_def_1', category: 'VOCABULARY', label: 'Matching Def (Bottom)', professionalLabel: 'Match the terms with the definitions at the bottom.', prompt: 'Part: Match the terms with the definitions at the bottom. List 10 terms. Provide 10 definitions in a randomized list at the very bottom of this section.', columnCount: 1 },
  { id: 'v_matching_def_2', category: 'VOCABULARY', label: 'Matching Def (Middle)', professionalLabel: 'Match the terms with the definitions in the middle.', prompt: 'Part: Match the terms with the definitions in the middle. List 5 terms, then the definitions bank, then another 5 terms.', columnCount: 1 },
  { id: 'v_matching_def_3', category: 'VOCABULARY', label: 'Matching Def (Side)', professionalLabel: 'Match the terms with the definitions on the right.', prompt: 'Part: Match the terms with the definitions on the right. Use a 2-column table. Col 1: Terms. Col 2: Definitions.', columnCount: 1 },
  { id: 'v_matching_def_4', category: 'VOCABULARY', label: 'Matching Def (Grid)', professionalLabel: 'Match the terms to the definitions in the grid.', prompt: 'Part: Match the terms to the definitions in the grid. Provide a grid of 10 definitions labeled A-J.', columnCount: 1 },
  { id: 'v_matching_def_5', category: 'VOCABULARY', label: 'Matching Def (Images)', professionalLabel: 'Match the terms to the descriptions (visual style).', prompt: 'Part: Match the terms to the descriptions. Use a highly visual layout with boxes for each term.', columnCount: 1 },

  { id: 'g_cloze_para_1', category: 'GRAMMAR', label: 'Close Paragraph (Style 1)', professionalLabel: 'Fill in the blanks in the paragraph.', prompt: 'Part: Fill in the blanks in the paragraph. Generate a 150-word paragraph with 10 numbered blanks. Provide 4 options for each blank at the end.', columnCount: 1 },
  { id: 'g_cloze_para_2', category: 'GRAMMAR', label: 'Close Paragraph (Style 2)', professionalLabel: 'Complete the story by filling in the blanks.', prompt: 'Part: Complete the story by filling in the blanks. Generate a narrative with 10 blanks. No options provided.', columnCount: 1 },
  { id: 'g_cloze_para_3', category: 'GRAMMAR', label: 'Close Paragraph (Style 3)', professionalLabel: 'Fill in the blanks with the correct verb forms.', prompt: 'Part: Fill in the blanks with the correct verb forms. Generate a paragraph with 10 blanks. Provide base verbs in parentheses.', columnCount: 1 },
  ...
  { id: 'g_cloze_para_5', category: 'GRAMMAR', label: 'Close Paragraph (Style 5)', professionalLabel: 'Fill in the blanks with appropriate articles.', prompt: 'Part: Fill in the blanks with appropriate articles. Generate a paragraph with 10 blanks.', columnCount: 1 },

  { id: 'g_matching_1', category: 'GRAMMAR', label: 'Matching (Clauses)', professionalLabel: 'Match the main clauses with the subordinate clauses.', prompt: 'Part: Match the main clauses with the subordinate clauses. Provide two columns of 10 items each.', columnCount: 1 },
  { id: 'g_matching_2', category: 'GRAMMAR', label: 'Matching (Questions)', professionalLabel: 'Match the questions with the correct answers.', prompt: 'Part: Match the questions with the correct answers. Provide two columns of 10 items each.', columnCount: 1 },
  { id: 'g_matching_3', category: 'GRAMMAR', label: 'Matching (Conditionals)', professionalLabel: 'Match the if-clauses with the result clauses.', prompt: 'Part: Match the if-clauses with the result clauses. Provide two columns of 10 items each.', columnCount: 1 },
  { id: 'g_matching_4', category: 'GRAMMAR', label: 'Matching (Phrasal Verbs)', professionalLabel: 'Match the phrasal verbs with their meanings.', prompt: 'Part: Match the phrasal verbs with their meanings. Provide two columns of 10 items each.', columnCount: 1 },
  { id: 'g_matching_5', category: 'GRAMMAR', label: 'Matching (Idioms)', professionalLabel: 'Match the idioms with their definitions.', prompt: 'Part: Match the idioms with their definitions. Provide two columns of 10 items each.', columnCount: 1 },

  // MORE T/F and C/I VARIATIONS
  { id: 'g_tf_1', category: 'GRAMMAR', label: 'True/False (Standard)', professionalLabel: 'Indicate whether the following sentences are grammatically True or False.', prompt: 'Part: True/False. Provide 10 sentences. Students mark ( T / F ).', columnCount: 1 },
  { id: 'g_tf_2', category: 'GRAMMAR', label: 'True/False (Correction)', professionalLabel: 'Mark True or False. If False, correct the error.', prompt: 'Part: True/False with Correction. Provide 10 sentences. If False, provide a line for correction.', columnCount: 1 },
  { id: 'g_tf_3', category: 'GRAMMAR', label: 'True/False (Context)', professionalLabel: 'Based on the context, are these sentences grammatically correct?', prompt: 'Part: Contextual True/False. Provide a short dialogue or paragraph, then 5 T/F statements about the grammar used.', columnCount: 1 },
  { id: 'g_tf_4', category: 'GRAMMAR', label: 'True/False (Rules)', professionalLabel: 'Are the following grammar rules True or False?', prompt: 'Part: Grammar Rule T/F. Test knowledge of rules (e.g., "We use \'since\' with a point in time.").', columnCount: 1 },
  { id: 'g_tf_5', category: 'GRAMMAR', label: 'True/False (Mixed)', professionalLabel: 'Mixed Grammar True/False.', prompt: 'Part: Mixed T/F. 10 items covering various grammar points.', columnCount: 1 },

  { id: 'g_ci_1', category: 'GRAMMAR', label: 'Correct/Incorrect (Standard)', professionalLabel: 'Write C for Correct or I for Incorrect.', prompt: 'Part: Correct/Incorrect. Provide 10 sentences with "____" prefix.', columnCount: 1 },
  { id: 'g_ci_2', category: 'GRAMMAR', label: 'Correct/Incorrect (Underline)', professionalLabel: 'Identify if the underlined part is Correct or Incorrect.', prompt: 'Part: C/I (Underline). Provide 10 sentences with one part underlined.', columnCount: 1 },
  { id: 'g_ci_3', category: 'GRAMMAR', label: 'Correct/Incorrect (Dialogue)', professionalLabel: 'Mark the sentences in this dialogue as C or I.', prompt: 'Part: Dialogue C/I. A short conversation where some lines have errors.', columnCount: 1 },
  { id: 'g_ci_4', category: 'GRAMMAR', label: 'Correct/Incorrect (Formal)', professionalLabel: 'Identify errors in formal writing.', prompt: 'Part: Formal C/I. Test formal vs informal grammar usage.', columnCount: 1 },
  { id: 'g_ci_5', category: 'GRAMMAR', label: 'Correct/Incorrect (Mastery)', professionalLabel: 'Advanced Error Detection.', prompt: 'Part: Mastery C/I. Complex sentences with subtle errors.', columnCount: 1 },
];
